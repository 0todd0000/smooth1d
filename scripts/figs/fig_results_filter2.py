...
leg0 = myplot.dummy_legend(AX[0], colors=['k']*2, labels=labels_noise, linestyles=['-', '--'], linewidths=[1]*2, loc='lower left', bbox_to_anchor=(0.43, 0.05))
leg1 = myplot.dummy_legend(AX[3], colors=colors, labels=labels_order, linestyles=['-']*4, linewidths=[2]*4, loc='lower left', bbox_to_anchor=(0.5, 0.1))
...
# pyplot.savefig('/Users/todd/Documents/Projects/projects/smooth/figs/results_filter2.pdf')